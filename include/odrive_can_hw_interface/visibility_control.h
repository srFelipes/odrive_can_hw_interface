...
#ifndef ODRIVE_CAN_HW_INTERFACE__VISIBILITY_CONTROL_H_
#define ODRIVE_CAN_HW_INTERFACE__VISIBILITY_CONTROL_H_
...
#endif  // ODRIVE_CAN_HW_INTERFACE__VISIBILITY_CONTROL_H_
